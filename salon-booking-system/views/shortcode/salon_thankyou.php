...
$pendingPayment = !$confirmation && $plugin->getSettings()->isPayEnabled() && in_array($plugin->getBookingBuilder()->getLastBooking()->getStatus(), array(SLN_Enum_BookingStatus::PENDING_PAYMENT));
...
$paymentMethod = ((!$confirmation) && $plugin->getSettings()->isPayEnabled()) ?
