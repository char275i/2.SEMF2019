...
<div class="sln-box sln-box--main">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-10 col-md-6 only-from-backend-attendant-enable-checkbox <?php echo $this->getOpt('attendant_enabled') ? '' : 'hide' ?>">
            <div class="sln-checkbox">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-10 col-md-6 form-group">
            <div class="sln-checkbox">
