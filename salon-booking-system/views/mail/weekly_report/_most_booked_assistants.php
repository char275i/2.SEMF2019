<table width="100%" cellspacing="0" cellpadding="0" border="0">
	...
	<?php if (!empty($stats['attendants'])) : ?>
	    ...
	    <?php foreach($stats['attendants'] as $sID => $count): ?>
		<tr>
		    <td style="font-size:1px;line-height:1px;" class="height4" valign="top" height="22" align="center">&nbsp;</td>
		</tr>
		<tr>
			...
			<?php echo $i ?> ) <?php echo $plugin->createAttendant($sID)->getName() ?> ( <?php echo $count ?> )
		    </td>
		</tr>
		<?php $i++ ?>
		<?php
	...
	<tr>
	    <td style="font-size:1px;line-height:1px;" class="height5" valign="top" height="64" align="center">&nbsp;</td>
	</tr>
    </tbody>
</table>
