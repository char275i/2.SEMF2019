...
//        }
    ...
    protected function render($content)
    {
        global $sln_license;
        $salon = $this;
        if (!defined("SLN_VERSION_CODECANYON") && defined("SLN_VERSION_PAY") && SLN_VERSION_PAY && $sln_license && !$sln_license->isValid()) {
            return $this->plugin->loadView('license/shortcode', compact('salon'));
        } else {
